  ...
  return (
    <div className="hwcheck">
      ...
      <header className="hwcheck__header">
        <div style={{ width: 36, height: 36, borderRadius: '50%', background: 'rgba(255,255,255,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18 }}>
          🎓
        </div>
      ...
      <div className="hwcheck__card">
        ...
        {screen === 'requirements' && (
          <>
            ...
            <div style={{ textAlign: 'left', marginBottom: 24 }}>
              {[
                { icon: '🌐', label: 'Browser', ok: true, detail: 'Chrome, Firefox, Edge, or Safari (latest)' },
                { icon: '📡', label: 'Internet', ok: true, detail: 'Stable connection recommended (2 Mbps+)' },
                { icon: '🖥️', label: 'Screen', ok: true, detail: 'Minimum 1024×768 resolution' },
                { icon: '🎤', label: 'Microphone', ok: true, detail: 'Required for Speaking section' },
                { icon: '🔊', label: 'Audio output', ok: true, detail: 'Speakers or headphones required' },
              ].map(req => (
        ...
        {screen === 'identity' && (
          <>
            ...
            <div style={{ background: 'var(--warning-bg)', border: '1px solid #fcd34d', borderRadius: 8, padding: '14px 16px', fontSize: 13, color: 'var(--warning)', marginBottom: 24, textAlign: 'left' }}>
              <strong>⚠️ Important:</strong> This is a proctored mock test. Impersonation or academic dishonesty will result in disqualification.
            </div>
            <p style={{ fontSize: 13, color: 'var(--text-muted)' }}>
        ...
        {screen === 'ready' && (
          <>
            ...
            <p className="hwcheck__desc">
              Your equipment is set up and you're ready to begin. The test will start with <strong>Reading</strong>, followed by Listening, Writing, and Speaking.
            </p>
            <div style={{ background: 'var(--teal-light)', border: '1px solid #a7d7d9', borderRadius: 8, padding: '14px 16px', fontSize: 13, textAlign: 'left', marginBottom: 24 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6, color: 'var(--teal-dark)' }}>
                ...
                <span>✍️ Writing — ~29 minutes</span>
                <span>🗣️ Speaking — ~16 minutes</span>
              </div>
            ...
            <p style={{ fontSize: 13, color: 'var(--danger)', fontWeight: 600, marginBottom: 24 }}>
              ⚠️ Once you begin, do not close the browser window.
            </p>
